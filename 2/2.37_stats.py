"""
Пример использования цепного правила в контексте машинного обучения для
вычисления градиента функции ошибки по параметрам модели (например, нейронной
сети) с использованием обратного распространения ошибки.
"""
